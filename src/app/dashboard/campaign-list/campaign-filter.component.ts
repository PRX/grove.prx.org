...
import { CampaignParams, Facets } from '../dashboard.service';
...
@Component({
  ...
  template: `
    ...
    <div class="text">
      <grove-filter-text textName="Campaign" [searchText]="params?.text" (search)="campaignListParams.emit({ text: $event, page: 1 })">
      </grove-filter-text>
      <grove-filter-text
        textName="Rep Name"
