...
@Component({
  ...
  template: `
    <mat-form-field appearance="outline">
      <input matInput [matDatepicker]="afterDate" [max]="before" [value]="after" (dateChange)="dateChange.emit({ after: $event.value })" />
    ...
    <mat-form-field appearance="outline">
      <input
        ...
        [min]="after"
        [value]="before"
        (dateChange)="dateChange.emit({ before: $event.value })"
      />
