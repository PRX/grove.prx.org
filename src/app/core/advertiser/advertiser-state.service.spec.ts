import { AdvertiserStateService } from './advertiser-state.service';
import { MockHalService } from 'ngx-prx-styleguide';
import { AuguryService } from '../augury.service';

describe('AdvertiserService', () => {
  let augury: MockHalService;
  let advertiserService: AdvertiserStateService;
  ...
  beforeEach(() => {
    ...
    advertiserService = new AdvertiserStateService(new AuguryService(augury as any));
